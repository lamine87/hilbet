    ...
    <div class="container">
        <div class="row">
            <main class="col-md-8 ml-sm-auto col-lg-8">
                <div class="">
                    <h1 class="">Ajouter un Employé</h1>
                </div>
                <form action="{{route('storeEmplye')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-8">
                            ...
                            <input type="text" class="form-control" id="prenom" name="prenom" value="{{old('prenom')}}" placeholder="Prenom">
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-8">
                            ...
                            <input type="text" class="form-control" id="poste" name="poste" value="{{old('poste')}}" placeholder="Designation">
                        </div>
                    </div>
